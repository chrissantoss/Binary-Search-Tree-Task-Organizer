...
public:
	...
	// PURPOSE: Tests single AVL rotations
	bool test9() {
		AVLTree obj;
		ASSERT_TRUE(obj.root == NULL);
		ASSERT_TRUE(obj.insert(BinarySearchTree::TaskItem(5, "Test Task")));
		ASSERT_TRUE(obj.insert(BinarySearchTree::TaskItem(2, "Test Task")));
		ASSERT_TRUE(obj.insert(BinarySearchTree::TaskItem(1, "Test Task")));
		ASSERT_TRUE(obj.is_balanced(obj.root) == true);
		ASSERT_TRUE(obj.insert(BinarySearchTree::TaskItem(4, "Test Task")));
		ASSERT_TRUE(obj.insert(BinarySearchTree::TaskItem(3, "Test Task")));
		ASSERT_TRUE(obj.is_balanced(obj.root) == true);

		AVLTree obj2;
		ASSERT_TRUE(obj2.root == NULL);
		ASSERT_TRUE(obj2.insert(BinarySearchTree::TaskItem(10, "Test Task")));
		ASSERT_TRUE(obj2.insert(BinarySearchTree::TaskItem(2, "Test Task")));
		ASSERT_TRUE(obj2.insert(BinarySearchTree::TaskItem(20, "Test Task")));
		ASSERT_TRUE(obj2.is_balanced(obj2.root) == true);
		ASSERT_TRUE(obj2.insert(BinarySearchTree::TaskItem(25, "Test Task")));
		ASSERT_TRUE(obj2.insert(BinarySearchTree::TaskItem(19, "Test Task")));
		ASSERT_TRUE(obj2.insert(BinarySearchTree::TaskItem(27, "Test Task")));
		ASSERT_TRUE(obj2.is_balanced(obj2.root) == true);
	...
	// PURPOSE: Tests double AVL rotations
	bool test10() {
		AVLTree obj;
		ASSERT_TRUE(obj.root == NULL);
		ASSERT_TRUE(obj.insert(BinarySearchTree::TaskItem(3, "Test Task")));
		ASSERT_TRUE(obj.insert(BinarySearchTree::TaskItem(6, "Test Task")));
		ASSERT_TRUE(obj.insert(BinarySearchTree::TaskItem(5, "Test Task")));
		ASSERT_TRUE(obj.is_balanced(obj.root) == true);

		AVLTree obj2;
		ASSERT_TRUE(obj2.root == NULL);
		ASSERT_TRUE(obj2.insert(BinarySearchTree::TaskItem(5, "Test Task")));
		ASSERT_TRUE(obj2.insert(BinarySearchTree::TaskItem(2, "Test Task")));
		ASSERT_TRUE(obj2.insert(BinarySearchTree::TaskItem(3, "Test Task")));
		ASSERT_TRUE(obj2.is_balanced(obj2.root) == true);

		AVLTree obj3;
		ASSERT_TRUE(obj3.root == NULL);
		ASSERT_TRUE(obj3.insert(BinarySearchTree::TaskItem(2, "Test Task")));
		ASSERT_TRUE(obj3.insert(BinarySearchTree::TaskItem(1, "Test Task")));
		ASSERT_TRUE(obj3.insert(BinarySearchTree::TaskItem(5, "Test Task")));
		ASSERT_TRUE(obj3.insert(BinarySearchTree::TaskItem(4, "Test Task")));
		ASSERT_TRUE(obj3.insert(BinarySearchTree::TaskItem(6, "Test Task")));
		ASSERT_TRUE(obj3.insert(BinarySearchTree::TaskItem(3, "Test Task")));
		ASSERT_TRUE(obj3.is_balanced(obj3.root) == true);
		
		AVLTree obj4;
		ASSERT_TRUE(obj4.root == NULL);
		ASSERT_TRUE(obj4.insert(BinarySearchTree::TaskItem(16, "Test Task")));
		ASSERT_TRUE(obj4.insert(BinarySearchTree::TaskItem(9, "Test Task")));
		ASSERT_TRUE(obj4.insert(BinarySearchTree::TaskItem(20, "Test Task")));
		ASSERT_TRUE(obj4.insert(BinarySearchTree::TaskItem(3, "Test Task")));
		ASSERT_TRUE(obj4.insert(BinarySearchTree::TaskItem(12, "Test Task")));
		ASSERT_TRUE(obj4.insert(BinarySearchTree::TaskItem(22, "Test Task")));
		ASSERT_TRUE(obj4.insert(BinarySearchTree::TaskItem(2, "Test Task")));
		ASSERT_TRUE(obj4.insert(BinarySearchTree::TaskItem(5, "Test Task")));
		ASSERT_TRUE(obj4.insert(BinarySearchTree::TaskItem(1, "Test Task")));
		ASSERT_TRUE(obj4.is_balanced(obj4.root) == true);
